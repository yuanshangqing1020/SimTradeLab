...
| 版本 | 状态 | 核心成果 | 文档 |
|---|---|---|---|
| **v1.0** | ✅ 已完成 | Holdout 年化 +60.51%，夏普 2.20，最大回撤 -16.28% | [查看 →](grid_multi_asset/v1.0/) |
| **v2.0** | ✅ WF/Holdout 已完成 | Trial 29；Holdout 年化 **+28.94%**，夏普 **1.43**，回撤 **-12.35%**（同上区间） | [查看 →](grid_multi_asset/v2.0/) |
