# strategies/grid_multi_asset_v4/optimization/optimized_strategy.py
# -*- coding: utf-8 -*-
"""
多标的自适应网格策略 v4 — WF 最优参数快照

由 `best_params_20260513_120438.json` 注入 `template.py` 生成；逻辑与 `backtest.py` 一致。
"""
import numpy as np
